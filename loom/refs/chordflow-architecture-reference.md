...
```
  ...
  └── library pane        saved exercises — page-level, both views
        ...
        │  the shell fans engine beats out to the score cursor, Now/Next, and the sheet marker
        ▼
  ┌────────────────────────────────────────────────────────────────────────────────┐
